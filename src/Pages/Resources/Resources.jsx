	...
	return (
		<div className='resources-wrapper'>
			...
			<div className="resources-section">
				...
				<h3 className="resources-disclaimer">This application is not endorsed by <span className="golden">Riot Games®</span> and does not reflect the views or opinions of <span className="golden">Riot Games®</span> or anyone officially involved in producing or managing <span className="golden">Riot Games®</span> properties. <span className="golden">Riot Games®</span> and all associated properties are trademarks or registered trademarks of <span className="golden">Riot Games®, Inc</span></h3>
			</div>
		</div>
	)
}
